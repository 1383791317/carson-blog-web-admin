...
export async function request(_url: string | RequestOptions, _config: RequestOptions = {}): Promise<resultType> {
  ...
  try {
    ...
    resultData.isSuccess = response.data.status === ResultEnum.SUCCESS;
  } catch (error: any) {
